...
const AboutMe = () => {
    const experience = aboutMeData.expirience.map((job, index) => {
        return (
            <div key={index}>
    ...
    const skills = aboutMeData.skills.map((skill, index) => {
        return (
            <li key={index} className="slill-item">
                {skill}
            </li>
        );
    });
                ...
                <Col>
                    <div className="contacts">
                        <div className="contact_item telegram me-2">
                            <a
                                href={aboutMeData.links.telegram}
                                target="_blank"
                            >
